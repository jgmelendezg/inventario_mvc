 ...
 */
?>
<h2 class="mb-4"><i class="bi bi-tools"></i> <?= htmlspecialchars($titulo) ?></h2>

<form method="POST" action="<?= $url_base ?>mantenimiento/registrar" class="row g-3">
    <div class="col-12">
        <div class="card p-4">
            <h5 class="card-title">Información del Equipo y Solicitud</h5>
            <hr>
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="id_equipo" id="id_equipo" class="form-select" required>
                        ...
                        <?php $equipos->data_seek(0); while ($eq = $equipos->fetch_assoc()): ?>
                            <option value="<?= htmlspecialchars($eq['id_equipo']) ?>">
                                <?= htmlspecialchars($eq['nombre_pc']) ?> (<?= htmlspecialchars($eq['area']) ?>)
                            </option>
                        <?php endwhile; ?>
                    </select>
                </div>
    ...
    <div class="col-12 mt-4">
        <div class="card p-4">
            <h5 class="card-title"><i class="bi bi-tools"></i> Diagnóstico y Soluciones</h5>
            <hr>
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="diagnostico" id="diagnostico" class="form-control" rows="3" placeholder="Ej: Disco duro dañado, sistema operativo corrupto."></textarea>
                </div>
                <div class="col-12">
                    <label for="soluciones" class="form-label">Soluciones Aplicadas:</label>
                    <textarea name="soluciones" id="soluciones" class="form-control" rows="3" placeholder="Ej: Se reemplazó el disco, se reinstaló el sistema."></textarea>
                </div>
                <div class="col-12">
                    <label for="recomendaciones" class="form-label">Recomendaciones Técnicas:</label>
                    <textarea name="recomendaciones" id="recomendaciones" class="form-control" rows="3" placeholder="Ej: Se recomienda hacer un respaldo de la información."></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 text-end mt-4">
        ...
        <button type="button" class="btn btn-outline-secondary"
                            onclick="location.href='<?= $url_base ?>mantenimiento/listar';">
